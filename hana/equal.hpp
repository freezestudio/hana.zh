...
#include <hana/concept/product.hpp>
...
#include <hana/detail/concepts.hpp>
#include <hana/detail/dependent_on.hpp>
#include <hana/detail/has_common_embedding.hpp>
#include <hana/detail/nested_to.hpp> // required by fwd decl
