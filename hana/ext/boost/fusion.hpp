...
#include <hana/ext/boost/fusion/deque.hpp>
#include <hana/ext/boost/fusion/list.hpp>
#include <hana/ext/boost/fusion/tuple.hpp>
#include <hana/ext/boost/fusion/vector.hpp>
